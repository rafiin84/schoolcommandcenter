...
import { MOBILE_OVERFLOW_NAV_ITEMS } from "@/components/navigation/nav-items";
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setOpen}>
      <SheetContent side="bottom" className="p-0">
        ...
        <nav className="flex flex-col gap-1 p-3" aria-label="More" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
